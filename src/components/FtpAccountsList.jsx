  ...
  return (
    <div>
            ...
            {ftpAccounts.map((ftpAccount) => (
              ...
              >
                <div className="w-4/5 flex flex-col sm:flex-row">
                  <span className="w-full sm:w-1/2">{ftpAccount.host}</span>
                  <span className="w-full sm:w-1/2">{ftpAccount.login}</span>
                </div>
                <div className="flex gap-2 w-1/5 justify-end">
                  ...
                  <button
                    ...
                    onClick={() => openDeleteModal(ftpAccount)}
                  >
                    <Trash2 />
                  </button>
                </div>
      ...
      <ConfirmDeleteModal
        ...
        itemName={selectedItem ? selectedItem.host : ""}
      />
    </div>
  );
}
